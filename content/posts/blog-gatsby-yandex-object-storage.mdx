...
##### Why Gatsby
As I mentioned in previous post I wanted to learn JS more.
That is why I decided not to use website constructors like Wordpress.

<br></br>

My first JS project was on React. I had choosen React over Vue and Angular,
because from the first glance I liked React syntax more.
...
(which I like from visual perspective), MDX (for quick notes) and lots of plugins.

<br></br>

Static website are very fast, since content is pre-rendered and stored on file server. 
...
For this things I've used gatsby plugins. You can find them in [package.json](https://github.com/bakuteyev/personal-site/blob/main/package.json).
...
At first time I used [s3fs](https://cloud.yandex.com/docs/storage/tools/s3fs) 
...
My requirement was to be able to add and modify posts from smartphone.
...
Just don't forget that gatsby stores its build in public folder.


<br></br>

##### Result and futture plans
I'm pretty happy with result I've got. Site is fast. 
...
It made already first prototype and it promises to be very cost efficient and easy to create.
